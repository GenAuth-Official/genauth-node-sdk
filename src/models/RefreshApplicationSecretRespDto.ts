...
import type { RefreshApplicationSecretDataDto } from "./RefreshApplicationSecretDataDto";

export type RefreshApplicationSecretRespDto = {
  /**
   ...
   *Response data
   */
  data: RefreshApplicationSecretDataDto;
};
