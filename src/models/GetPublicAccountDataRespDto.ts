...
import type { GetUserSelectLoginPublicAccountsDataDto } from "./GetUserSelectLoginPublicAccountsDataDto";

export type GetPublicAccountDataRespDto = {
  /**
   ...
   *Response data
   */
  data: Array<GetUserSelectLoginPublicAccountsDataDto>;
};
