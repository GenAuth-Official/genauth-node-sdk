...
import type { CheckResourcePermissionDataDto } from "./CheckResourcePermissionDataDto";

export type CheckResourcePermissionsRespDto = {
  /**
   ...
   *Response data
   */
  data: CheckResourcePermissionDataDto;
};
