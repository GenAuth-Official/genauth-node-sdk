...
export type GenerateQrcodeDto = {
  ...
  context?: any;
  /**
   * When type is `WECHAT_MINIPROGRAM`, whether to automatically merge the customized logo into the generated image, the default is false. The process of merging QR codes on the server will increase the interface response speed. It is recommended to use the default value and stitch the images on the client. If you use GenAuth's SDK, you can save the manual splicing process.
   */
