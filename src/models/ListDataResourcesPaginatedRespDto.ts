...
import type { DataResourcesPaginatedRespDto } from "./DataResourcesPaginatedRespDto";

export type ListDataResourcesPaginatedRespDto = {
  /**
   ...
   *Response data
   */
  data: DataResourcesPaginatedRespDto;
};
