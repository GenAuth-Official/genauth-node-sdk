...
import type { ListPermissionViewPaginatedRespDto } from "./ListPermissionViewPaginatedRespDto";

export type ListPermissionViewResponseDto = {
  /**
   ...
   *Response data
   */
  data: ListPermissionViewPaginatedRespDto;
};
