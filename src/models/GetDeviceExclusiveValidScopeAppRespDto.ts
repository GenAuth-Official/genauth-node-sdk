...
import type { DeviceExclusiveValidScopeAppDataDto } from "./DeviceExclusiveValidScopeAppDataDto";

export type GetDeviceExclusiveValidScopeAppRespDto = {
  /**
   ...
   *Response data
   */
  data: Array<DeviceExclusiveValidScopeAppDataDto>;
};
