...
import type { GetPushCodeRelationAppsDataDto } from "./GetPushCodeRelationAppsDataDto";

export type GetPushCodeRelationAppsRespDto = {
  /**
   ...
   *Response data
   */
  data: GetPushCodeRelationAppsDataDto;
};
