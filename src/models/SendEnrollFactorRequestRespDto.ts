...
import type { SendEnrollFactorRequestDataDto } from "./SendEnrollFactorRequestDataDto";

export type SendEnrollFactorRequestRespDto = {
  /**
   ...
   *Response data
   */
  data: SendEnrollFactorRequestDataDto;
};
