...
import type { GetFastpassQRCodeRelationAppsDto } from "./GetFastpassQRCodeRelationAppsDto";

export type GetFastpassQRCodeRelationAppsRespDto = {
  /**
   ...
   *Response data
   */
  data: GetFastpassQRCodeRelationAppsDto;
};
