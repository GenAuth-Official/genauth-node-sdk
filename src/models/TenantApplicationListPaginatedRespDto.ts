...
import type { TenantApplicationListPagingDto } from "./TenantApplicationListPagingDto";

export type TenantApplicationListPaginatedRespDto = {
  /**
   ...
   * data
   */
  data: TenantApplicationListPagingDto;
};
