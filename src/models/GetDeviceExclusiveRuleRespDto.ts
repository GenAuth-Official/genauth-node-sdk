...
import type { GetDeviceExclusiveRuleDataDto } from "./GetDeviceExclusiveRuleDataDto";

export type GetDeviceExclusiveRuleRespDto = {
  /**
   ...
   *Response data
   */
  data: GetDeviceExclusiveRuleDataDto;
};
