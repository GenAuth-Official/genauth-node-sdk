...
import type { DecryptDouyinMiniProgramPhoneDataDto } from "./DecryptDouyinMiniProgramPhoneDataDto";

export type DecryptDouyinMiniProgramPhoneRespDto = {
  /**
   ...
   *Response data
   */
  data: DecryptDouyinMiniProgramPhoneDataDto;
};
