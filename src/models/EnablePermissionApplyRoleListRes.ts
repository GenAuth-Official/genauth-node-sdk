...
import type { EnablePermissionApplyRolePageList } from "./EnablePermissionApplyRolePageList";

export type EnablePermissionApplyRoleListRes = {
  /**
   ...
   *Response data
   */
  data: EnablePermissionApplyRolePageList;
};
