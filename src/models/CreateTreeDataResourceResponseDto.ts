...
import type { CreateTreeDataResourceRespDto } from "./CreateTreeDataResourceRespDto";

export type CreateTreeDataResourceResponseDto = {
  /**
   ...
   *Response data
   */
  data: CreateTreeDataResourceRespDto;
};
