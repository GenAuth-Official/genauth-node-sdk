...
export type PreviewEmailTemplateDto = {
  ...
  /**
   * Email content template, optional. If not passed, the email template configured by the user pool will be used for rendering by default.
   */
  content?: string;
  /**
   * Email subject, optional. If not passed, the email template configured by the user pool will be used for rendering by default.
   */
  subject?: string;
  /**
   * Email sender name, optional, if not passed, the email template configured by the user pool will be used for rendering by default.
   */
  sender?: string;
  /**
   * Verification code/email validity time, only verification emails have validity time. Optional, if not passed, the email template configured by the user pool will be used for rendering by default.
   */
  expiresIn?: number;
  /**
