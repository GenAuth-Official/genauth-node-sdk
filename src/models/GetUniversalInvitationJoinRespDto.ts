...
import type { UniversalInvitationJoinRespDto } from "./UniversalInvitationJoinRespDto";

export type GetUniversalInvitationJoinRespDto = {
  /**
   ...
   *Response data
   */
  data: UniversalInvitationJoinRespDto;
};
