...
import type { TriggerSyncRiskOperationsDataDto } from "./TriggerSyncRiskOperationsDataDto";

export type TriggerSyncRiskOperationsRespDto = {
  /**
   ...
   *Response data
   */
  data: TriggerSyncRiskOperationsDataDto;
};
