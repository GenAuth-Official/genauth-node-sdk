...
import type { CreateArrayDataResourceRespDto } from "./CreateArrayDataResourceRespDto";

export type CreateArrayDataResourceResponseDto = {
  /**
   ...
   *Response data
   */
  data: CreateArrayDataResourceRespDto;
};
