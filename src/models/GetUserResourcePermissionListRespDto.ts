...
import type { GetUserResourcePermissionListDataDto } from "./GetUserResourcePermissionListDataDto";

export type GetUserResourcePermissionListRespDto = {
  /**
   ...
   *Response data
   */
  data: GetUserResourcePermissionListDataDto;
};
