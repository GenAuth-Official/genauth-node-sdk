...
import type { GetMfaInfoDataDto } from "./GetMfaInfoDataDto";

export type SetMfaStatusDto = {
  /**
   *MFA Factor List
   */
  mfaTriggerData: GetMfaInfoDataDto;
  /**
   ...
   *
   */
  userIdType?: SetMfaStatusDto.userIdType;
};

export namespace SetMfaStatusDto {
  /**
   * User ID type, the default value is `user_id`, the optional values are:
   * - `user_id`: GenAuth user ID, such as `6319a1504f3xxxxf214dd5b7`
   * - `phone`: user’s mobile phone number
