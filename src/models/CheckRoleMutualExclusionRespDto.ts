...
import type { CheckRoleMutualExclusionResultDto } from "./CheckRoleMutualExclusionResultDto";

export type CheckRoleMutualExclusionRespDto = {
  /**
   ...
   * data
   */
  data: CheckRoleMutualExclusionResultDto;
};
