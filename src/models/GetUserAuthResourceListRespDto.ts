...
import type { GetUserAuthResourceListDataDto } from "./GetUserAuthResourceListDataDto";

export type GetUserAuthResourceListRespDto = {
  /**
   ...
   *Response data
   */
  data: GetUserAuthResourceListDataDto;
};
