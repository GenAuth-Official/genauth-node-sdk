...
import type { DataPoliciesSimplePaginatedRespDto } from "./DataPoliciesSimplePaginatedRespDto";

export type ListSimpleDataPoliciesPaginatedRespDto = {
  /**
   ...
   *Response data
   */
  data: DataPoliciesSimplePaginatedRespDto;
};
