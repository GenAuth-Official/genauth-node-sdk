...
import type { PaginationUniversalInvitationApplicantDataDto } from "./PaginationUniversalInvitationApplicantDataDto";

export type PaginationUniversalInvitationApplicantRespDto = {
  /**
   ...
   *Response data
   */
  data: PaginationUniversalInvitationApplicantDataDto;
};
