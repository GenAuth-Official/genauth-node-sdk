...
import type { InviteTenantUserRecordListDto } from "./InviteTenantUserRecordListDto";

export type InviteTenantUserRecordListRespDto = {
  /**
   ...
   *Response data
   */
  data: InviteTenantUserRecordListDto;
};
