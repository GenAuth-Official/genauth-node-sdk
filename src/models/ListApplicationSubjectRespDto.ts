...
import type { ListApplicationSubjectDataListDto } from "./ListApplicationSubjectDataListDto";

export type ListApplicationSubjectRespDto = {
  /**
   ...
   *Response data
   */
  data: ListApplicationSubjectDataListDto;
};
