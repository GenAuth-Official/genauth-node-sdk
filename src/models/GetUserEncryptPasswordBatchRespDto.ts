...
import type { GetUserEncryptPasswordBatchDataDto } from "./GetUserEncryptPasswordBatchDataDto";

export type GetUserEncryptPasswordBatchRespDto = {
  /**
   ...
   *Response data
   */
  data: GetUserEncryptPasswordBatchDataDto;
};
