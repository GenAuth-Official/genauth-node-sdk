...
import type { UniversalInvitationPublicConfigDto } from "./UniversalInvitationPublicConfigDto";

export type GetUniversalInvitationPublicConfigRespDto = {
  /**
   ...
   *Response data
   */
  data: UniversalInvitationPublicConfigDto;
};
