...
import type { ListApplicationAuthPaginatedDataDto } from "./ListApplicationAuthPaginatedDataDto";

export type ListApplicationAuthPaginatedRespDto = {
  /**
   ...
   *Response data
   */
  data: ListApplicationAuthPaginatedDataDto;
};
