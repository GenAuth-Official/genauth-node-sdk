...
import type { GetPermissionNamespaceRespDto } from "./GetPermissionNamespaceRespDto";

export type GetPermissionNamespaceListResponseDto = {
  /**
   ...
   *Response data
   */
  data: Array<GetPermissionNamespaceRespDto>;
};
