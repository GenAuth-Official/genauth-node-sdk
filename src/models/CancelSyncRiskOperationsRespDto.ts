...
import type { CancelSyncRiskOperationsDataDto } from "./CancelSyncRiskOperationsDataDto";

export type CancelSyncRiskOperationsRespDto = {
  /**
   ...
   *Response data
   */
  data: CancelSyncRiskOperationsDataDto;
};
