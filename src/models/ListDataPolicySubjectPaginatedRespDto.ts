...
import type { ListDataPolicySubjectPageDto } from "./ListDataPolicySubjectPageDto";

export type ListDataPolicySubjectPaginatedRespDto = {
  /**
   ...
   *Response data
   */
  data: ListDataPolicySubjectPageDto;
};
