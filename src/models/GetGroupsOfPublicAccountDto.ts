...
/**
 * Obtain the public account group list through the public account ID, and you can choose to specify the user ID type, etc.
 */
export type GetGroupsOfPublicAccountDto = {
  /**
   * The user's unique identifier can be user ID, user name, email, mobile phone number, external ID, or ID in an external identity source.
   */
  userId?: any;
  /**
