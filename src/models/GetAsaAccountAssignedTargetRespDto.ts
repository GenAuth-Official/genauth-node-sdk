...
import type { GetAsaAccountAssignedTargetDataDto } from "./GetAsaAccountAssignedTargetDataDto";

export type GetAsaAccountAssignedTargetRespDto = {
  /**
   ...
   *Response data
   */
  data: GetAsaAccountAssignedTargetDataDto;
};
