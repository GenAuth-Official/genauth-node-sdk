...
import type { GetUserAuthResourceStructDataDto } from "./GetUserAuthResourceStructDataDto";

export type GetUserAuthResourceStructRespDto = {
  /**
   ...
   *Response data
   */
  data: GetUserAuthResourceStructDataDto;
};
