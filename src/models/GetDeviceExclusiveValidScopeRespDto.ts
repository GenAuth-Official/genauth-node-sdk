...
import type { GetDeviceExclusiveValidScopeDataDto } from "./GetDeviceExclusiveValidScopeDataDto";

export type GetDeviceExclusiveValidScopeRespDto = {
  /**
   ...
   *Response data
   */
  data: Array<GetDeviceExclusiveValidScopeDataDto>;
};
