...
import type { CheckParamsDataResourceRespDto } from "./CheckParamsDataResourceRespDto";

export type CheckParamsDataResourceResponseDto = {
  /**
   ...
   *Response data
   */
  data: CheckParamsDataResourceRespDto;
};
