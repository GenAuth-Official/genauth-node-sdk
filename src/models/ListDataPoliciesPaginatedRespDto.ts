...
import type { DataPoliciesPaginatedRespDto } from "./DataPoliciesPaginatedRespDto";

export type ListDataPoliciesPaginatedRespDto = {
  /**
   ...
   *Response data
   */
  data: DataPoliciesPaginatedRespDto;
};
