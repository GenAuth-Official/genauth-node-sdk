...
/**
 * Obtain user real-name authentication information through user ID, and you can choose to specify the user ID type.
 */
export type GetUserPrincipalAuthenticationInfoDto = {
  /**
