...
import type { CreateStringDataResourceRespDto } from "./CreateStringDataResourceRespDto";

export type CreateStringDataResourceResponseDto = {
  /**
   ...
   *Response data
   */
  data: CreateStringDataResourceRespDto;
};
