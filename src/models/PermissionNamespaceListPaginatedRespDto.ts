...
import type { PermissionNamespaceListPagingDto } from "./PermissionNamespaceListPagingDto";

export type PermissionNamespaceListPaginatedRespDto = {
  /**
   ...
   * data
   */
  data: PermissionNamespaceListPagingDto;
};
