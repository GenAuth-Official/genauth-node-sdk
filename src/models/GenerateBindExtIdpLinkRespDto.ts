...
import type { GenerateBindExtIdpLinkDataDto } from "./GenerateBindExtIdpLinkDataDto";

export type GenerateBindExtIdpLinkRespDto = {
  /**
   ...
   *Response data
   */
  data: GenerateBindExtIdpLinkDataDto;
};
