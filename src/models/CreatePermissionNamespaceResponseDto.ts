...
import type { CreatePermissionNamespaceRespDto } from "./CreatePermissionNamespaceRespDto";

export type CreatePermissionNamespaceResponseDto = {
  /**
   ...
   *Response data
   */
  data: CreatePermissionNamespaceRespDto;
};
