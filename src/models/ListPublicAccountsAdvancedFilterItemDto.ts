...
export type ListPublicAccountsAdvancedFilterItemDto = {
    /**
     * Advanced search for specified public account fields:
     * - `id`: public account ID
     * - `phone`: mobile phone number
     * - `email`: email
     * - `username`: username
     * - `externalId`: the ID of the public account in the external system
     * - `name`: name
     * - `status`: public account status, optional values are `Activated` and `Suspended`
     * - `gender`: public account gender, optional values are `M` (male), `F` (female) and `U` (unknown)
     ...
     * - `userSource`: public account source, see examples for specific usage
     * - `department`: public account department, see examples for specific usage
