...
import type { MultipleTenantAdminListPagingDto } from "./MultipleTenantAdminListPagingDto";

export type MultipleTenantAdminPaginatedRespDto = {
  /**
   ...
   *Response data
   */
  data: MultipleTenantAdminListPagingDto;
};
