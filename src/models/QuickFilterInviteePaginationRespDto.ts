...
import type { QuickFilterInviteePaginationDto } from "./QuickFilterInviteePaginationDto";

export type QuickFilterInviteePaginationRespDto = {
  /**
   ...
   *Response data
   */
  data: QuickFilterInviteePaginationDto;
};
