...
import type { InvitationRosterPaginationDto } from "./InvitationRosterPaginationDto";

export type InvitationRosterPaginationRespDto = {
  /**
   ...
   *Response data
   */
  data: InvitationRosterPaginationDto;
};
