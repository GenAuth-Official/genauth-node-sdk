...
import type { CheckPermissionNamespaceExistsRespDto } from "./CheckPermissionNamespaceExistsRespDto";

export type PermissionNamespaceCheckExistsRespDto = {
  /**
   ...
   *Response data
   */
  data: CheckPermissionNamespaceExistsRespDto;
};
