...
import type { EnablePermissionApplyApplicationList } from "./EnablePermissionApplyApplicationList";

export type EnablePermissionApplyApplicationListRes = {
  /**
   ...
   *Response data
   */
  data: EnablePermissionApplyApplicationList;
};
