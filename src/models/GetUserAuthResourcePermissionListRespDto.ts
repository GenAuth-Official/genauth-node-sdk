...
import type { GetUserAuthResourcePermissionListDataDto } from "./GetUserAuthResourcePermissionListDataDto";

export type GetUserAuthResourcePermissionListRespDto = {
  /**
   ...
   *Response data
   */
  data: GetUserAuthResourcePermissionListDataDto;
};
