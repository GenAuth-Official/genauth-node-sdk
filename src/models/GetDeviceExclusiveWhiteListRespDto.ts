...
import type { GetDeviceExclusiveWhiteListDataDto } from "./GetDeviceExclusiveWhiteListDataDto";

export type GetDeviceExclusiveWhiteListRespDto = {
  /**
   ...
   *Response data
   */
  data: Array<GetDeviceExclusiveWhiteListDataDto>;
};
