...
import type { TenantCooperatorListPagingDto } from "./TenantCooperatorListPagingDto";

export type TenantCooperatorPaginatedRespDto = {
  /**
   ...
   *Response data
   */
  data: TenantCooperatorListPagingDto;
};
