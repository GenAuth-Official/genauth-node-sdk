...
import type { PaginationInvitationPolicyDataDto } from "./PaginationInvitationPolicyDataDto";

export type PaginationInvitationPolicyRespDto = {
  /**
   ...
   *Response data
   */
  data: PaginationInvitationPolicyDataDto;
};
