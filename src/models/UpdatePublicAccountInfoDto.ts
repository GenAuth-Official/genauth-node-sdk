...
export type UpdatePublicAccountInfoDto = {
  /**
   ...
   */
  status?: UpdatePublicAccountInfoDto.status;
  /**
   ...
   * gender
   */
  gender?: UpdatePublicAccountInfoDto.gender;
  /**
...
export namespace UpdatePublicAccountInfoDto {
  /**
   * Current status of account
   */
  export enum status {
