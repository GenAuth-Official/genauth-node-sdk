...
import type { GetApplicationPermissionStrategyDataDto } from "./GetApplicationPermissionStrategyDataDto";

export type GetApplicationPermissionStrategyRespDto = {
  /**
   ...
   *Response data
   */
  data: GetApplicationPermissionStrategyDataDto;
};
